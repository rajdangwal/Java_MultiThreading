...
class MyThread2 extends Thread //insted of extending Thread class we can implement Runnable interface. Much beneficial while inheriting from other classes.
{
    public void run()//mandatory to override.
    {
        for(int i=0;i<10;i++)
...
public class ThreadDemo2 
{
    public static void main(String args[])
    {
        ...
        Thread t = new Thread(t2); //start can't be called on runnable object. Pass runnable object as parameter to Thread object.
